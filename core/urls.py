...
urlpatterns = [
    ...
    path('administrator/uploads/', admin_pages.administrator_uploads, name='administrator_uploads'),
    path('administrator/uploads/<int:upload_id>/forward/', admin_pages.forward_upload, name='forward_upload'),
